...
#        self.batch_shape.insert(0, None) # prepend None for variable batch size
    ...
    def __call__(self, inp, training=False):
        ...
        for i in range(self.nb_stacks):
            ...
            with tf.name_scope("hourglass_{}_lin_layer_1x1_conv".format(i)):
            ...
            if(i < self.nb_stacks-1): # if this isn't the last hourglass
                with tf.name_scope("hourglass_{}_1x1_conv".format(i)):
                ...
                with tf.name_scope("hourglass_{}_transformed_heatmaps".format(i)):
                    transformed = conv_layer(heatmaps, self.nb_channels, (1, 1), (1, 1), (0, 0)) # transform the predictions back with a conv layer to prepare for add-op
